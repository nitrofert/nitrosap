...
@Component({
  selector: 'app-new-solped-mp',
  providers:[MessageService],
  templateUrl: './new-solped-mp.component.html',
  styleUrls: ['./new-solped-mp.component.scss']
})
export class NewSolpedMpComponent implements OnInit {
